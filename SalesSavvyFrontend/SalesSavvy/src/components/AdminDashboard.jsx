...
const AdminDashboard = () => {
    ...
    const handleDeleteProductSubmit = async ({ productId }) => {
        try {
            ...
            setResponse({ message: "Error: Failed to delete product" });
        }
    };
    ...
    const handleViewUserSubmit = async ({ userId }) => {
        try {
            ...
            setResponse({ message: "Error: Failed to fetch user details" });
            setModalType("response");
        }
    };
    ...
    const handleUpdateUserSubmit = async (data) => {
        try {
            ...
            setResponse({ message: "Error: Failed to update user" });
            setModalType("response");
        }
    };
